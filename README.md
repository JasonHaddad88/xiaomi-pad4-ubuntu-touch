...
loud audio, charging while off. **Partly:** all 30 sensors work (accelerometer, gyroscope, light, hall
effect), but rotation and screen turn-off are currently mutually exclusive - the vendor sensors HAL
cannot serve both sensorfw and android's sensorservice; screen turn-off is enabled (one-line swap).
**Not working:** camera. **Untested:** Bluetooth, suspend/resume and battery drain.
